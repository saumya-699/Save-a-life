...
if($report =="pending"){
    $sql= "select * from sent_request where Requesting_hospital_name= '$HospitalName' and status='Pending' and Date between '$From' and '$To'";
...
else if($report =="Not-Available"){
    $sql= "select * from sent_request where Requesting_hospital_name= '$HospitalName' and status='Not Available' and Date between '$From' and '$To'";
   $result = $conn->query($sql);
...
else if($report =="processing"){
    $sql= "select * from sent_request where Requesting_hospital_name= '$HospitalName' and status='Processing' and Date between '$From' and '$To'";
   $result = $conn->query($sql);
   ...
   
   {
    ...
    $sql= "select * from sent_request where Requesting_hospital_name= '$HospitalName' and status='Available' and Date between '$From' and '$To'";
   $result = $conn->query($sql);
