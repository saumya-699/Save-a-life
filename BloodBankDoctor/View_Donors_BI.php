    ...
    <div class="layout has-sidebar fixed-sidebar fixed-header">
      ...
      <div class="layout">
        ...
        //----------------------------------------then find the donors who have that hospital id in donor table
          $sql = "select * from donation_records,donors where donors.Donor_Id =donation_records.Donor_Id 
          where donors.username!='Removed' and donation_records.Hospital_ID=$hid
          group by donoration_records.Donor_Id"
           ;
