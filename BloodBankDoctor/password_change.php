            ...
            <div class="wrap">
              ...
              <form action="change_password_backend.php" method="POST">
                ...
                <div class='row btn-buttons'>
                  ...
                  <a href="update_profile.php"><input type='submit' name='submit' value='Update' class='bx'></a>
                  <input type='submit' name='BtnSubmit' value='Cancel' class='bx' onclick='history.back()'>
