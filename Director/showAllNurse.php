...
{	
   ...
   $result= $conn->query($query);
	   ...
	   echo  "<div style='overflow-x:auto;' class='tab'>";
	    // echo  "<div class='hat'>";
	   echo  "<table border=1>"."<tr>"."<th style='text-align:center;width:120px;'>"."Nurse_ID"."</th>"."<th style='text-align:center;width:100px;'>"."Name_With_Initials"."</th>"."<th style='text-align:center;width:100px;'>"."NIC"."</th>"."<th>"."Hospital name"."</th>"."<th>"."Position"."</th>"."<th>"."DOB"."</th>"."<th>"."SLMC number"."</th>"."<th>"."Email"."</th>"."<th style='text-align:center;width90px;'>"."Contact number"."</th>"."<th style='text-align:center;width:120px;'>"."Date of appoinment"."</th>"."<th>"."Remark"."</th>"."<th>"."Director_ID"."</th>"."<th style='text-align:center:width:40px;'>"."Action"."</th>"."</tr>";
      echo "<tr>"."<td style='height:20px;background-color:#F5F5F5;'colspan=10'>"."</td>"."</tr>";
   while($row = $result->fetch_assoc())
   
   {     
     
	  echo  "<tr>"."<td>".$row["Nurse_ID"]."</td>"."<td>".$row["Name_With_Initials"]."</td>"."<td>".$row["NIC"]."</td>"."<td>".$row["HospitalName"]."</td>"."<td>".$row["Position"]."</td>"."<td>".$row["DOB"]."</td>"."<td>".$row["SLMC_Number"]."</td>"."<td>".$row["Email"]."</td>"."<td>".$row["ContactNumber"]."</td>"."<td>".$row["Date_of_appoinment"]."</td>"."<td>".$row["Remark"]."</td>"."<td>".$row["Director_ID"]."</td>";
	   echo "<td>
				<form method='POST' action ='Fill_NurseUpdateFormBackEnd.php'>
                ...
                <form method='POST' action ='DeleteNurse.php'>
                <input type=hidden  name=Nurse_ID value=".$row["Nurse_ID"]." >
