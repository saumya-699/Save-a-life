...
$search =$_POST["search"];
$data =$_POST["data"];		 
$sql= "select * from BloodBank_doctor WHERE $search='$data'";  
...
{     
   ...
   {     
	  ...
	  echo  "<tr>"."<td>".$row["BloodBank_doctor_ID"]."</td>"."<td>".$row["Name_With_Initials"]."</td>"."<td>".$row["HospitalName"]."</td>"."<td>".$row["SLMC_Number"]."</td>";
	   echo "<td><form method='POST' action ='showAllBB.php'>
