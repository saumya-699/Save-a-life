...
a {text-decoration: none;}
 ...
 &nbsp; <img src="ashi.png" class="sin">
                     ...
                     <form method="post" action="loginBBBackEnd.php">
                  
         
                        <b> <label class="lb"><font size=6><font color= #ff0000>User ID</font></font><label></b><br>
                             <input type="text" placeholder="Enter BloodBank_doctor_ID" name="BloodBank_doctor_ID" class="validation" id="User ID" required><br>
