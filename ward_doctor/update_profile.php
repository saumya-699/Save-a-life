      ...
      <div class="layout">
        <main class="content">
            ...
            <?php
                ...
                ?>
                <form action="update_profile_backend.php" method="POST">
                  <center><span><h1>Update Profile</h1></span><center>
                   ...
                   <input type="text" class="form-control txt-input" name="Name"value="<?php echo $name; ?>">
                    ...
                    <input type="text" class="form-control txt-input" value="<?php echo $username; ?>" readonly>
                            ...
                            <div class='row btn-buttons'>
                                   ...
                                   <a href="update_profile_backend.php"><input type='submit' name='BtnSubmit' value='Update' class='b1'></a>
                                   <a href="password_change.php"><input type='button' name='passwordChange' value='Change Password'/></a>
                              </div>
               </form>
</div>
</div>
