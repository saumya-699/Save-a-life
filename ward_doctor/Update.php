                        ...
                        ?>
                                <form action="Updatebackend.php" method="POST">
                                    ...
                                    <div class="input-group mb-4 ">
                                        <input type="date" name="date_of_birth" placeholder="date_of_birth" value="<?php echo $rows['date_of_birth']; ?>" max="<?= date('Y-m-d') ?>">
                                    </div>
                                    ...
                                    <div class="input-group mb-4 ">
                                        <input type="date" name="expected_date" placeholder="Expected_date" value="<?php echo $rows['expected_date']; ?>" min="<?= date('Y-m-d') ?>">
                                    </div>
                                    ...
                                    <div class="row btn-buttons ">
                                        <button class="b1" name="saveChanges" value="saveChanges">
                                            <font size="2px">Edit</font size>
                                        </button> &nbsp; &nbsp; &nbsp; &nbsp;
                                        &nbsp; &nbsp; &nbsp; &nbsp; <button class="b1" name="cancel" value="cancel"><a href="Update.php">
