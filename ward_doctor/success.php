...
<div class="sidenav">
 ...
 <br>
 <div class="wel">
 <p><b> <font size="2px">Successfully requested</font></b></p>
 <button class="b1" name="back" value="back"><a href="Make blood request.php"><font size="2px">go back</font></a></button>
 &nbsp; &nbsp; <button class="b1" name="view" value="view"><a href="Request History1.php"><font size="2px">go to view</font></a></button>
