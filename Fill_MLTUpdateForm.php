...
echo "<div class='midiv'> 
   <div class='passwordDiv'>
     ...
     <form method='post' action='UpdateMLTBackEnd.php'>
                           ...
                           <center> <b> <font size=8> Update MLT</font></b><br></center>
						   
						   <br> <br> <br>
						   
                              
                               <input type='hidden' value=".$row["MLT_ID"]." name='MLT_ID' id='MLT_ID' class='box'><br><br><br>
  ...
  <div  class=container'>
     ...
     <button type=submit  name=BtnSubmit id=saveChanges class=b1 ><b>Update</b></button>
	   ...
	   <button type=button  name=btnCancel id=Cancel class=b2 ><b><a href=RemoveOrUpdateMLT.php><font color=white>Cancel</font></a></b></button>
