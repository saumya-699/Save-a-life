    ...
    <div class="box">
        ...
        <form action="Request history2.php" method="POST">
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo  "<div class='tab'>";
                    echo  "<table border=1>"."<tr>"."<th style='text-align:center;'>"."Blood bag ID"."</th>"."<th style='text-align:center;'>"."Blood group"."</th>"."<th style='text-align:center;width:120px;'>"."Component type"."</th>"."<th>"."No of packs"."</th>"."<th>"."Expiry date"."</th>"."<th style='text-align:center;width:40px;'>"."Action"."</th>"."</tr>";
                    echo "<tr>"."<td style='height:20px;background-color:#F5F5F5;'colspan=8'>"."</td>"."</tr>";
                 while($row = $result->fetch_assoc()) {    
                           
     
     echo  "<tr>"."<td>xx</td>"."<td>yy</td>"."<td>xxx</td>"."<td>xxx</td>"."<td>yyy</td>";   
