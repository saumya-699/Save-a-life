...
<head>
    ...
    <link rel="stylesheet" href="./css/styleloginmlt.css">
...
<body>
    ...
    <div class="container frm-login">
        ...
        <div class="card frm-form">
            ...
            <div class="card-body frm-body">
                <form action="login.php" method="POST">
                    ...
                    <label for="exampleFormControlInput1" class="form-label lbl">
                        <div style="margin-top:-20px;"><b>Password</b>
                    </label>
            </div>
            ...
            <br>
            <p></p>
            <p><button type="submit" class="btn btn-primary btn-login">Login</button></p>
