...
<div class="sidenav">
    <button class="dropdown-btn" style=background-color:#DB2A54;><a href="seeMLT.php">Home</a>
    </button>
  
  <button class="dropdown-btn">
  <a href=".php"><a href="view donated blood information.php">View donated blood</a>
  </button>
