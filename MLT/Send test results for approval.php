    ...
    <div class="box">
        ...
        <form action="Send test results for approval1.php" method="POST">
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo  "<div class='tab'>";
                    echo  "<table border=1>"."<tr>"."<th style='text-align:center;'>"."Date"."</th>"."<th style='text-align:center;'>"."Batch number"."</th>"."<th style='text-align:center;width:120px;'>"."Click to view more information"."</th>"."<th style='text-align:center;width:120px;'>"."Click button to request for approval"."</th>"."</tr>";
