...
echo "<div class='midiv'> 
   <div class='passwordDiv'>
     ...
     <form method='post' action='UpdateBB_backEnd.php'>
                           ...
                           <center> <b> <font size=8> Update blood bank <br><br><br> doctor</font></b><br></center>
						   
						   <br> <br> <br>
						   
                              
                               <input type='hidden' value=".$row["BloodBank_doctor_ID"]." name='BloodBank_doctor_ID' id='BloodBank_doctor_ID' class='box'><br><br><br>
  ...
  <div  class=container'>
     ...
     <button type=submit  name=BtnSubmit id=saveChanges class=b1 ><b>Update</b></button>
	   ...
	   <button type=button  name=btnCancel id=Cancel class=b2 ><b><a href=RemoveOrUpdateBB.php><font color=white>Cancel</font></a></b></button>
