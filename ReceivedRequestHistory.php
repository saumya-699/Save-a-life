...
{     
	   ...
	   echo  "<table border=1>"."<tr>"."<th style='text-align:center;width:120px;'>"."Requesting_hospital_name"."</th>"."<th>"."Requested_hospital_name"."</th>"."<th>"."Requested_by"."</th>"."<th>"."Requeired_blood_group"."</th>"."<th style='width:120px;'>"."Requeired_blood_component"."</th>"."<th>"."Requeired_no_of_packs"."</th>"."<th style='width:220px;'>"."Date"."</th>"."<th style='width:120px;'>"."Status"."</th>"."</tr>";
      echo "<tr>"."<td style='height:20px;background-color:#F5F5F5;'colspan=8'>"."</td>"."</tr>";
   while($row = $result->fetch_assoc())
   
   {     
     
	  echo  "<tr>"."<td>".$row["Requesting_hospital_name"]."</td>"."<td>".$row["Requested_hospital_name"]."</td>"."<td>".$row["Requested_by"]."</td>"."<td>".$row["Requeired_blood_group"]."</td>"."<td>".$row["Requeired_blood_component"]."</td>"."<td>".$row["Requeired_no_of_packs"]."</td>"."<td>".$row["Date"]."</td>"."<td>".Pending."</td>";
