          ...
          <div class="container">
            ...
            if ($resultx->num_rows > 0) {
              ...
              while ($row = $resultx->fetch_assoc()) {
                ...
                echo "<tr class='$status_class'><td>" . $row["blood_group"] . "</td><td>" . $row["requested_date"] . "</td><td>" . $z . "</td><td><form method='POST' action ='bloodrequestnotify.php'><button type=submit value=view name=view  class='fp'><i class='fa-solid fa-arrow-right'></i></button><input type=hidden name=RequestID value=" . $row["requeste_id"] . " ></form></td></tr>";
              }
