...
$sql= "select * from donation_records where Hospital_ID='$y'" ;
...
{     
     ...
     $sql = "SELECT Donation_date, COUNT(DISTINCT Batch) AS batch_count, COUNT(*) AS blood_packet_count FROM donation_records GROUP BY Donation_date";
$result = $conn->query($sql);
...
if ($result->num_rows > 0) {
	   ...
	   echo  "<table id='dataTable' border=1>"."<tr>"."<th style='text-align:center;width:120px;'>"."Donation Date"."</th>"."
       <th style='text-align:center;'>"."No of Batch"."
       <th style='text-align:center;'>"."No of Blood Packets"."</th>"."
       </tr>";
      echo "<tr>"."<td style='height:20px;background-color:#F5F5F5;'colspan=8'>"."</td>"."</tr>";
   while($row = $result->fetch_assoc())
   
   {          
      $position_class = strtolower(str_replace(' ', '-', $row['Donation_date']));
      echo '<tr class="' . $position_class . '">'; 
	  echo  "<td>".$row["Donation_date"]."</td>"."<td>".$row["batch_count"]."</td>"."<td>".$row["blood_packet_count"]."</td>";
	  echo "</tr>";
