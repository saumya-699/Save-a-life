            ...
            <div class="container">
              <div class="wrap">
               ...
               <label for="exampleFormControlInput1" class="form-label lbl star">Donor ID</label>
                    <input type="text" name="donorid" id="donorid" class="form-control txt-input" placeholder="Donor ID" required>
                   ...
                   <input type="text" class="form-control txt-input" placeholder="Type NIC Number" name="nic" id="nic" pattern="[0-9]{9}[Vv0-9]{1,3}" required onchange="fillDonorInfo()">

                   <label for="exampleFormControlInput1" class="form-label lbl star">Weight(Kg)</label>
                    <div class="input-group mb-4">
                    <input type="text" name="weight" class="datepicker_input form-control txt-input" placeholder="weight" pattern="^[1-9][0-9]{0,2}(\.[0-9]{1,2})?$" required>
                    </div>

                   <label for="exampleFormControlInput1" class="form-label lbl">Height(cm)</label>
                    <input type="text" class="form-control txt-input" placeholder="Height" name="height" pattern="[0-9]{2,3}" required >

                    <label for="exampleFormControlInput1" class="form-label lbl star">Blood Pressure(mmHg)</label>
                    <input type="text"name="bpressure" class="form-control txt-input" placeholder="Blood Pressure" pattern="\d{2,3}\/\d{2,3}" required>

                    <label for="exampleFormControlInput1" class="form-label lbl star">Hemoglobine Level(g/dl)</label>
                    <input type="text" class="form-control txt-input" placeholder="Hemoglobine Level" name="hemoglobine" pattern="^\d{1,2}(\.\d{1,2})?$" required>
