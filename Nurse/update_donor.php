...
<script src="https://code.jquery.com/jquery-2.1.4.min.js"></script><link rel="stylesheet" href="./update_donor.css">
...
<div class="layout has-sidebar fixed-sidebar fixed-header">
  ...
  <div class="container">
    <div class="wrap">
      <div class="headings">
        <center><span><h1>Update Donor Details</h1></span><center>
...
echo "
								<form method='post' action='update_donor_backend.php'>
                               ...
                               <input type='text' value=".$row["Prefix"]." name='id'  class='form-control txt-input'>
							   
							   <label for='exampleFormControlInput1' class='form-label lbl star'>Full Name</label> 
                               <input type='text' value=".$row["Full_Name"]." name='id'  class='form-control txt-input'>
                      
                               <label for='exampleFormControlInput1' class='form-label lbl star'>Name with Initials</label> 
                               <input type='text' value=".$row["Initials"]." name='Name' id='name' class='form-control txt-input'>
                              ...
                              <label for='exampleFormControlInput1' class='form-label lbl star'>NIC Number</label>
                               ...
                               <input type='text' value=".$row["Address"]." name='Address' class='form-control txt-input' >

                               <label for='exampleFormControlInput1' class='form-label lbl star'>Province</label>
                               <input type='text' value=".$row["province"]." name='Address' class='form-control txt-input' >

                               <label for='exampleFormControlInput1' class='form-label lbl star'>Postal</label>
                               <input type='text' value=".$row["postal"]." name='Address' class='form-control txt-input' >
                               ...
                               <input type='text' value=".$row["mobile_number"]." name='Address' class='form-control txt-input'  >
          
  
                               <label for='exampleFormControlInput1' class='form-label lbl star'>Land Number</label>
                              <input type='text' value=".$row["land_number"]." name='contactNumber'  class='form-control txt-input'  >
              
                   
  
                              <div class='row btn-buttons'>
                          
                              <input type='submit' name='btnCancel' value='Update' class='b1'>
